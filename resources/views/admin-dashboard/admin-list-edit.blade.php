                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown dropleft user-vendor ">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        ...
                                        <a class="dropdown-item" href="{{ route('admin-listingsv">Listings</a>
        ...
        <div class="dashboard-sidebar offcanvas-collapse">
            ...
            <div class="dashboard-nav">
                <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="{{ route('admin-listings') }}"><span class="dash-nav-icon"><i class="fas fa-list-alt"></i> </span>Listings</a>
        ...
        <div class="dashboard-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            <h3 class="dashboard-page-title">Edit Listing</h3>
                ...
                <div class="card">
                    ...
                    <div class="">
                        <form action="{{ url('admin-edit-list') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                @else
                                <div class="form-group px-4">
                                    <input class="form-check-input" name="featured" type="checkbox" value="featured" id="flexCheckChecked" checked>
                                    <label class="form-check-label font-weight-bold" for="flexCheckDefault">
                                        Featured
                                    </label>
                                </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                @else
                                <div class="form-group px-4">
                                    <input class="form-check-input" name="status" type="checkbox" value="status" id="flexCheckChecked" checked>
                                    <label class="form-check-label font-weight-bold" for="flexCheckDefault">
                                        Status
                                    </label>
                                </div>
