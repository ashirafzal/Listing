    ...
    <div id="app">
        ...
        <main>
            <div class="container-fluid p-4">
                    ...
                    @foreach($Listing as $Listings)
                        ...
                        <div class="container container-a">
                            <div class="img">
                                ...
                                <img class="img3" src="listing-image/{{ $Listings->image2 }}" alt="">
                                <img class="img4" src="listing-image/{{ $Listings->image3 }}" alt="">
                            </div>
                            <div class="text">
                                <div class="title">
                                    <a href="list-detail/{{ $Listings->id }}">{{$Listings->title}}</a>
                                </div>
                                <div class="desc">
                ...
                @else
                <div class="container container-a p-4 text-center">
                    <h2>No listing available at the moment</h2>
                @endif
            </div>
        </main>
